...
function SingleCourse({ params }: Props) {
  const selectedCourse = tajweedCourses.courses.find(
                  ...
                  <div className="mt-3 flex flex-col align-items-center justify-content-between">
                    ...
                    {!!courses.length && (
                      <div className="flex justify-around w-full">
                        <button
                          className="bg-primary/80 text-white rounded-full px-10 py-2 cursor-pointer hover:opacity-80"
                          onClick={handleNext}
                        ...
                        <button
                          className="border border-gray-300 rounded-full px-10 py-2 cursor-pointer hover:bg-primary/70 hover:text-white transition-all"
